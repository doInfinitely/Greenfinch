            ...
            {[
              {
                ...
                description: 'See property type, use, location, and size at a glance. Instantly filter to the properties that fit your service profile — no more driving around to find them.',
                icon: (
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">Filter by property type, use, location, and size</span>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
