    ...
    <>
      <div className="p-4">
        ...
        <div>
          ...
          <div className="max-h-48 md:max-h-48 overflow-y-auto space-y-1">
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Content */}
            <div 
              className="relative w-full max-h-[80vh] bg-white rounded-t-xl overflow-hidden flex flex-col animate-slide-up"
            >
              <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
                <h2 id="mobile-filter-title" className="font-semibold text-gray-900">Filters</h2>
                <button
                  onClick={() => setIsOpen(false)}
          ...
          {/* Desktop: Dropdown */}
          <div className="hidden md:block absolute top-full left-0 mt-2 w-72 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
            <FilterContent />
          </div>
        </>
      )}
