...
- **Name Normalization**: Owner/mgmt names from AI enrichment are normalized via `normalizeOwnerName()` (title-case with corporate suffix preservation) to prevent raw DCAD all-caps names from being stored.
